...
import {SiJavascript,SiTypescript,SiExpress,SiMongodb,SiChakraui,SiAuth0,SiRedux, SiMaterialui} from "react-icons/si"
    ...
    <Box p="25px" bg="#22252c" color="white" id="Projects" >
      ...
      >
        ...
        >
          <Box   zIndex={1}
          position="relative">
            <Image src={thinkmania} alt="Project 1"   zIndex={1}
          position="relative" />
            <Heading color="#0bf0c1" as="h3" size="md" mt={2}   zIndex={1}
          position="relative">
              Think-Mania
            </Heading>
            <br />
          ...
          position="relative">
            ...
            <HStack mt={3} h="fit-content" spacing={7}   zIndex={1}
          position="relative">
            <FaReact size={30} color="rgb(0, 215, 254)"/>|<SiTypescript size={28} color="rgb(0, 122, 203)"/>|<SiChakraui size={30} color="rgb(77, 181, 171)"/>|<FaNodeJs size={30} color=" rgb(139, 199, 75)"/>|<SiExpress size={30} color="rgb(129, 129, 129)"/>|<SiMongodb size={30} color=" rgb(73, 156, 74)"/>
            </HStack>
            {/* <Text  as="code">
        ...
        >
          <Box   zIndex={1}
          position="relative">
            <Image src={getintouch} alt="Project 1"   zIndex={1}
          position="relative" />
            <Heading color="#0bf0c1" as="h3" size="md" mt={2}   zIndex={1}
          position="relative">
              GetInTouch
            ...
            <Text fontSize="sm"   zIndex={1}
          position="relative">
             GetInTouch is a social media web application built with the MERN stack, which enhances the 
             user experience with a seamless user interface
            </Text>
            <Heading color="#0bf0c1" as="h3" size="md" mt={2}   zIndex={1}
          position="relative">
              Tech Stack
            ...
            <HStack mt={3} h="fit-content" spacing={7}   zIndex={1}
          position="relative">
            <FaReact size={30} color="rgb(0, 215, 254)"/> | <SiRedux size={30} color="rgb(118, 74, 187)"/> | <SiMaterialui size={30} color="rgb(41, 181, 245)"/>|<FaNodeJs size={30} color=" rgb(139, 199, 75)"/>|<SiExpress size={30} color="rgb(129, 129, 129)"/>|<SiMongodb size={30} color=" rgb(73, 156, 74)"/>
            </HStack>
            {/* <Text  as="code">
              <FaReact  color="red"/> | TypeScript | Chakra Ui | Node.js | Express.js | MongoDB
            </Text> */}
        ...
        >
          <Box>
            ...
            <FaReact size={30} color="rgb(0, 215, 254)"/>|<SiRedux size={30} color="rgb(118, 74, 187)"/>|<SiChakraui size={30} color="rgb(77, 181, 171)"/>|<FaNodeJs size={30} color="rgb(139, 199, 75)"/>|<SiExpress size={30} color="rgb(129, 129, 129)"/>|<SiMongodb size={30} color="rgb(73, 156, 74)"/>
            </HStack>
            {/* <Text as="code">
        ...
        >
          <Box>
            ...
            <HStack mt={3} h="fit-content" spacing={7}>
            <FaReact size={30} color="rgb(0, 215, 254)"/>|<SiChakraui size={30} color="rgb(77, 181, 171)"/>|<SiJavascript size={30} color="rgb(254, 213, 0)"/>|<SiAuth0 size={30} color="#ffff"/>
            </HStack>
        ...
        >
          ...
          <Box>
            ...
            <HStack mt={3} h="fit-content" spacing={7}>
            <FaReact size={30} color="rgb(0, 215, 254)"/>|<SiChakraui size={30} color="rgb(77, 181, 171)"/>|<DiCss3 size={37} color=" rgb(2, 119, 188)"/>|<SiJavascript size={30} color="rgb(254, 213, 0)"/>
            </HStack>
        ...
        >
          ...
          <Box>
            ...
            <HStack mt={3} h="fit-content" spacing={7}>
            <FaHtml5 size={35} color="rgb(227, 77, 38)"/>|<DiCss3 size={37} color="rgb(2, 119, 188)"/>|<SiJavascript size={30} color="rgb(254, 213, 0)"/>
             </HStack>
